...
const PopularCategory = () => {
  return (
    ...
    <div className="flex pt-4 gap-6 overflow-x-scroll w-screen "> {/* Add 'overflow-x-auto' for horizontal scrolling */}
      {/* filtering requried  venue*/}
      {venue_list
        .filter((venue) => venue.category === 'most-popular')
        .map((venue) => (
          <div key={venue.id} className="text-lg">
            <div className="w-56">
              {/* venue image */}
            ...
            <div className="flex gap-1 items-center">
              ...
              <div className="text-lime-600 text-xl" ><BiFoodTag/></div>
              <div className="text-red-900 text-xl"><BiFoodTag/></div>
